    ...
    return (
        <button
            ...
            className={cn(
                ...
                "text-[14px] font-normal text-white transition-all duration-100 ease-out",

                // Cores e Borda
                "border border-[#4c5667] bg-[#4c5667]",

                // Transições e Hover
                "hover:bg-[#363e4a] focus:outline-none",

                // Efeito "Afundar"
                "active:bg-[#2a313a] active:shadow-[inset_0_3px_5px_rgba(0,0,0,0.2)] active:scale-[0.98]",
