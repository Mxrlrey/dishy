    ...
    return (
        <button
            ...
            className={cn(
                ...
                // Cores e Borda
                "border border-transparent bg-[#34d3eb]",

                // Transições e Hover
                "hover:bg-[#2cb9ce] focus:outline-none",

                // Efeito "Afundar"
                "active:bg-[#24a0b2] active:shadow-[inset_0_3px_5px_rgba(0,0,0,0.2)] active:scale-[0.98]",

                // Estados de desabilitado
                "disabled:opacity-25",

                // Tamanhos dinâmicos
                children ? "px-4 py-2" : "px-4 py-1",
